    ...
    namespace http
    {
        ...
        ***************/
        void on_request_method(void *data, const char *at, size_t length)
        {
            ...
            {
                LJRSERVER_LOG_WARN(g_logger) << "invalid http request method: "
        ...
        void on_request_version(void *data, const char *at, size_t length)
        {
            ...
            {
                LJRSERVER_LOG_WARN(g_logger) << "invalid http request version: " << std::string(at, length);
        ...
        size_t HttpRequestParser::execute(char *data, size_t len)
        {
            ...
            // if (offset == -1)
            // {
            //     LJRSERVER_LOG_WARN(g_logger) << "invalid request:" << std::string(buff, len);
            // }
            // else if (offset != -1)
            // {
        ...
        ***************/
        ...
        void on_response_version(void *data, const char *at, size_t length)
        {
            ...
            {
                LJRSERVER_LOG_WARN(g_logger) << "invalid http response version: " << std::string(at, length);
                parser->setError(1001);
                return;
            }
