...
namespace ljrserver
{
    ...
    namespace http
    {
        ...
        HttpResponse::ptr HttpConnection::recvResponse()
        {
            ...
            if (client_parser.chunked)
            {
                ...
                do
                {
                    ...
                    LJRSERVER_LOG_INFO(g_logger) << "content_len = " << client_parser.content_len;
        ...
        HttpResult::ptr HttpConnection::DoRequest(HttpRequest::ptr req, Uri::ptr uri, uint64_t timeout_ms)
        {
            ...
            if (rt == 0)
            {
                return std::make_shared<HttpResult>((int)HttpResult::Error::SEND_SLOSE_BY_PEER, nullptr,
        ...
        ***********************/
        ...
        void HttpConnectionPool::ReleasePtr(HttpConnection *ptr, HttpConnectionPool *pool)
        {
            ...
            if (!ptr->isConnected() ||
                (ptr->m_createTime + pool->m_maxAliveTime) >= ljrserver::GetCurrentMS() ||
